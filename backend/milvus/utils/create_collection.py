...
# 4. Create collection
client.create_collection(collection_name="dummy", schema=schema, index_params=index_params)

# 5. Describe the collection
res = client.describe_index(collection_name="dummy", index_name="embedding_index")
print(res)