...
const ViewMorePopup = ({ viewImages, title, setOpenViewMore, columnCount, rowToDisplay }) => {
    ...
    return (
        <div className='fixed top-0 left-0 h-full w-full flex flex-col justify-center items-center bg-black bg-opacity-50' style={{zIndex: "10000"}}>
        <div className='absolute flex flex-row justify-center items-center w-[95%] h-[92%] bg-white rounded-2xl pb-3'>
            ...
            <h4 className='font-tahoma font-bold text-center pt-8 pb-2'>{title}</h4>
