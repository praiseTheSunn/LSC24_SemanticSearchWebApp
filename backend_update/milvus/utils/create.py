...
schema.add_field(field_name="image_id", datatype=DataType.VARCHAR, max_length=100)
...
# 4. Create collection
client.create_collection(collection_name="vbs25_v3c_clips", schema=schema, index_params=index_params)
# client.create_collection(collection_name="lsc24_clips", schema=schema, index_params=index_params)

# 5. Describe the collection
res = client.describe_index(collection_name="vbs25_v3c_clips", index_name="embedding_index")
