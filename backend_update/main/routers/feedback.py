...
async def get_feedback(payload: RequestFeedback):
    ...
    response = {
        "like": prepare_response(payload.dataset, response_relevant["record_ids"], display_window_size=0),
        "dislike": prepare_response(payload.dataset, response_irrelevant["record_ids"], display_window_size=0)
    }
